...
export default function ImageGenerator({generateImage}: ImageGeneratorProps){
  const [inputText, setInputText] = useState(""); //takes value from form input
  const [isLoading, setIsLoading] = useState(false); //once user presses submit button, loading is set
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col justify-center p-8">
      <main className="flex-1 m-auto">
        ...
        <footer className="w-full max-w-64 mx-auto">
